    ...
    return (
        <Card className="bg-base-100 shadow-xl">
            <div className="text-center mb-6">
                <Typography variant="subtitle" size="xl" weight="bold" className="mb-2">Bem-vindo de volta!</Typography>
                <Typography variant="caption" size="base">Acesse sua conta para continuar</Typography>
            </div>
